...
namespace Bilayer {
     ...
     */
     template class EuclideanScalarProd<1,1,double>;
     template class EuclideanScalarProd<1,2,double>;
     template class EuclideanScalarProd<1,3,double>;
     template class EuclideanScalarProd<2,1,double>;
     template class EuclideanScalarProd<2,2,double>;
     template class EuclideanScalarProd<2,3,double>;

     template class EuclideanScalarProd<1,1,std::complex<double> >;
     template class EuclideanScalarProd<1,2,std::complex<double> >;
     template class EuclideanScalarProd<1,3,std::complex<double> >;
     template class EuclideanScalarProd<2,1,std::complex<double> >;
     template class EuclideanScalarProd<2,2,std::complex<double> >;
     template class EuclideanScalarProd<2,3,std::complex<double> >;
